...
public interface DynamicSet<Key extends Comparable<Key> , Value> {
	...
	* This method returns zero if the set is empty <br>
	*	    
	...
	* If the map previously contained a mapping for the key, the old value is replaced.<br>
	...
	*/
    ...
    /**
	* Returns the value to which the specified key is mapped, or null if this set contains no mapping for the key.
	* 
	...
	*/
    ...
    /**
   	* Returns a key-value mapping associated with the least key in this map, or null if the set is empty.
   	* IMPORTANT: This operation only applies when there is a total ordering on the Key <br>
