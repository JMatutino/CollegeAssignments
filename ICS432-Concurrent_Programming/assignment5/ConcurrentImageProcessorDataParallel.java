...
public class ConcurrentImageProcessorDataParallel {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            if (args.length == 3) {
                filterThreadNum = Integer.parseInt(args[argumentNum]);
        ...
        public void run() {
            ...
            while(processedSoFar < numFiles) {
                ...
                if(filterUse.equalsIgnoreCase("oil1")){
                    ...
                    filter = new DataParallelWeirdFilter(filterThreadNum);
                    newFile = "./weird_image";
                }
                else {
